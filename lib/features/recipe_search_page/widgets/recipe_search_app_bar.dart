    ...
    return SliverAppBar(
      ...
      flexibleSpace: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          // Determine the current height of the AppBar.  This is crucial.
          double appBarHeight = constraints.maxHeight;

          //  Calculate the collapsed height dynamically.  Adjust the multiplier (0.5)
          //  as needed to control how much the collapsed height adapts to the
          //  content. Experiment with different formulas.
          double collapsedHeight =
              kToolbarHeight + (appBarHeight - kToolbarHeight) * 0.5;
                    ...
                    child: isModified
                        ? Container(
                            ...
                            child: SizedBox(
                              ...
                              width: 20,
                              child: TextButton(
                                onPressed: () => clearSearchParameters(
